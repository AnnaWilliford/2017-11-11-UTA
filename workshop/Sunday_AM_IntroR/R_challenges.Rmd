...
```
Break the following expression into multiple single function calls. You will need to assign the output of each function to a variable that will serve as input(argument) for a next function. What does the output of each step tell you? Assign: `score<-"High"`
...
* Element 3 is a list that contains the address of the restaurant (Abram st.) and the total dollar amount (12.56) of your order
